...
from fasterlmm.bundle import (BUNDLE_FILENAME, BUNDLE_PARTS_DIRNAME, BundleWriter, bundle_outdir,
                              merge_bundle_parts)
...
def _make_table(pheno_name, n_rows = 5, *, dict_pheno = False):
    ...
    cols = {"sid_index": pa.array(np.arange(n_rows), type = pa.int64()),
            ...
            "Nullh2": pa.array(rng.uniform(0, 1, n_rows), type = pa.float64()), "Pheno": pheno_col,
