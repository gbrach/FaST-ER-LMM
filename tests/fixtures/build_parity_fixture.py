...
SRC_PLINK = REPO / "data" / "GWAS" / "matrix.SNPs.InDels.SVs.CNVs.plink"
SRC_PHEN_DIR = REPO / "data" / "GWAS" / "phenotypes" / "glucose"
SRC_COVAR = REPO / "data" / "GWAS" / "covariates_matrix_glucose.tab"
